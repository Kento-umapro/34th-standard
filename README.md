...
| No | 事業 | 内容 |
|---|---|---|
| 01 | 日米間の輸出入 | 総論。ミルワーク・食品・家具など日本製プロダクト全般の輸出入 |
| 02 | 米国での卸売 | 「おもちのプリン」など日本の食品を、ディーラー網経由でアメリカの飲食店へ卸す |
| 03 | 店舗デザイン・施工 | 和風・和洋折衷の意匠設計と、それに伴う施工 |
| 04 | 進出コンサルティング | 不動産・法務・会計・銀行・VISAなど、進出インフラの支援 |
| 05 | マスターフランチャイズ | 日本の飲食企業の米国出店における本部機能。加盟開発・店舗運営・ブランド管理 |
| 06 | 建築資材の輸出・現地施工 | 内外装資材を日本から輸出し現地で施工。米国の製作会社より安く、納期は1日単位 |

03と06は隣接しています。03は「デザインを起点にした案件」、06は「資材供給とコスト・納期を起点にした案件」として書き分けています。
